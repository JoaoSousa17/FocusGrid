...
export default function Login() {
  ...
  const handleMetaLogin = async () => {
    ...
    try {
      ...
      setError(t("error") + ": Meta sign in failed.");
    }
  };
      ...
      className="w-full max-w-sm relative z-10">
        ...
        <div className="flex flex-col gap-3">
          <Button
            ...
            variant="outline"
            className="w-full h-12 rounded-2xl border-border bg-white hover:bg-secondary/50 transition-all text-sm font-medium gap-2">
